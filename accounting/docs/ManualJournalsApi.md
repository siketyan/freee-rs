...
> crate::models::GetManualJournals200Response get_manual_journals(company_id, start_issue_date, end_issue_date, entry_side, account_item_id, min_amount, max_amount, partner_id, partner_code, item_id, section_id, segment_1_tag_id, segment_2_tag_id, segment_3_tag_id, comment_status, comment_important, adjustment, txn_number, offset, limit)
振替伝票一覧の取得
...
[**crate::models::GetManualJournals200Response**](get_manual_journals_200_response.md)
