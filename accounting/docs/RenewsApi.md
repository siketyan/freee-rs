...
------------- | ------------- | -------------
[**create_deal_renew**](RenewsApi.md#create_deal_renew) | **POST** /api/1/deals/{id}/renews | 取引（収入・支出）の+更新の作成
...
**renew_create_params** | [**RenewCreateParams**](RenewCreateParams.md) | 取引（収入・支出）の+更新の作成 | [required] |
