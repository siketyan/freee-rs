...
pub struct TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
...
impl TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment2TagsInner {
