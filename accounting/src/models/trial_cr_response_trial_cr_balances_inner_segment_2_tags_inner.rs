...
pub struct TrialCrResponseTrialCrBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
...
impl TrialCrResponseTrialCrBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialCrResponseTrialCrBalancesInnerSegment2TagsInner {
