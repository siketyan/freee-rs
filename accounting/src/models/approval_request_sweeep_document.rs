...
pub struct ApprovalRequestSweeepDocument {
    ...
    pub sweeep_document_id: uuid::Uuid,
    /// 表示用の書類コード
...
impl ApprovalRequestSweeepDocument {
    pub fn new(approval_request_id: i32, sweeep_document_id: uuid::Uuid, sweeep_document_code: String, sweeep_document_path: String, company_id: i32) -> ApprovalRequestSweeepDocument {
