...
pub struct TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner {
    pub fn new() -> TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner {
