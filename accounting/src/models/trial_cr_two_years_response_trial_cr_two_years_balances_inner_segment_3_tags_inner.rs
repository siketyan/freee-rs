...
pub struct TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment3TagsInner {
    /// セグメント3タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント3タグ名
...
impl TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment3TagsInner {
    pub fn new(id: i32) -> TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment3TagsInner {
