...
pub struct TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInnerSectionsInner {
