...
pub struct TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerPartnersInner {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先名
...
impl TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerPartnersInner {
    pub fn new(id: i32) -> TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerPartnersInner {
