...
pub struct TrialPlResponseTrialPlBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub sections: Option<Vec<crate::models::TrialPlResponseTrialPlBalancesInnerSectionsInner>>,
...
impl TrialPlResponseTrialPlBalancesInner {
    pub fn new() -> TrialPlResponseTrialPlBalancesInner {
