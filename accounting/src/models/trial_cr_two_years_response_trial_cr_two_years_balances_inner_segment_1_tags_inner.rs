...
pub struct TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialCrTwoYearsResponseTrialCrTwoYearsBalancesInnerSegment1TagsInner {
