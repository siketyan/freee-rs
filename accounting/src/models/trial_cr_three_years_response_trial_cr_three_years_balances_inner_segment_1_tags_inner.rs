...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment1TagsInner {
