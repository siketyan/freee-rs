...
pub struct TrialCrResponseTrialCrBalancesInnerPartnersInner {
    /// 取引先ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 取引先名
...
impl TrialCrResponseTrialCrBalancesInnerPartnersInner {
    pub fn new(id: i32) -> TrialCrResponseTrialCrBalancesInnerPartnersInner {
