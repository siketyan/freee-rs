...
pub struct ExpenseApplicationParentApprovalRequestUpdateParams {
    /// 事業所ID
...
impl ExpenseApplicationParentApprovalRequestUpdateParams {
    pub fn new(company_id: i32, parent_id: Option<i32>) -> ExpenseApplicationParentApprovalRequestUpdateParams {
        ExpenseApplicationParentApprovalRequestUpdateParams {
            company_id,
            parent_id,
        }
    }
