...
pub struct ApiV1EmployeesControllerPeriodCreateResponse {
    #[serde(rename = "employee", skip_serializing_if = "Option::is_none")]
    pub employee: Option<Box<crate::models::ApiV1EmployeeSerializer>>,
}

impl ApiV1EmployeesControllerPeriodCreateResponse {
    pub fn new() -> ApiV1EmployeesControllerPeriodCreateResponse {
