...
pub struct ApiV1EmployeesProfileRulesControllerPeriodUpdateBody {
    /// 更新対象事業所ID（必須）
    ...
    #[serde(rename = "month")]
    pub month: i32,
    #[serde(rename = "employee_profile_rule")]
    pub employee_profile_rule: Box<crate::models::ApiV1EmployeesProfileRuleUpdateRequestSerializer>,
}

impl ApiV1EmployeesProfileRulesControllerPeriodUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_profile_rule: crate::models::ApiV1EmployeesProfileRuleUpdateRequestSerializer) -> ApiV1EmployeesProfileRulesControllerPeriodUpdateBody {
        ApiV1EmployeesProfileRulesControllerPeriodUpdateBody {
            company_id,
            year,
            month,
            employee_profile_rule: Box::new(employee_profile_rule),
        }
    }
}
