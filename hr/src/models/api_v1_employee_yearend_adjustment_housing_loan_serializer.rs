...
pub struct ApiV1EmployeeYearendAdjustmentHousingLoanSerializer {
    /// 住宅ローンID
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i32>,
    /// 居住開始の年月日
    #[serde(rename = "residence_start_date", skip_serializing_if = "Option::is_none")]
    pub residence_start_date: Option<String>,
    /// 住宅借入金等年末残高
    #[serde(rename = "remaining_balance_at_yearend", skip_serializing_if = "Option::is_none")]
    pub remaining_balance_at_yearend: Option<i32>,
    /// 住宅借入金等特別控除区分 general: 住: 一般の住宅借入金等, qualified: 認: 認定住宅の新築等, extension: 増: 特定増改築等, earthquake: 震: 震災特例法による特別控除
    #[serde(rename = "category", skip_serializing_if = "Option::is_none")]
    pub category: Option<Category>,
    /// 特定取得/特別特定取得 not_qualified: 該当しない, specified: 特定取得, special_specified_or_special_exception: 特別特定取得または特別特例取得, exception_special_exception: 特例特別特例取得
    #[serde(rename = "specific_case_type", skip_serializing_if = "Option::is_none")]
    pub specific_case_type: Option<SpecificCaseType>,
}

impl ApiV1EmployeeYearendAdjustmentHousingLoanSerializer {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentHousingLoanSerializer {
        ApiV1EmployeeYearendAdjustmentHousingLoanSerializer {
            id: None,
            residence_start_date: None,
            remaining_balance_at_yearend: None,
            category: None,
            specific_case_type: None,
        }
    }
}
...
/// 特定取得/特別特定取得 not_qualified: 該当しない, specified: 特定取得, special_specified_or_special_exception: 特別特定取得または特別特例取得, exception_special_exception: 特例特別特例取得
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum SpecificCaseType {
    #[serde(rename = "not_qualified")]
    NotQualified,
    #[serde(rename = "specified")]
    Specified,
    #[serde(rename = "special_specified_or_special_exception")]
    SpecialSpecifiedOrSpecialException,
    #[serde(rename = "exception_special_exception")]
    ExceptionSpecialException,
}

impl Default for SpecificCaseType {
    fn default() -> SpecificCaseType {
        Self::NotQualified
    }
}
