...
pub struct ApiV1EmployeesControllerPeriodIndexResponse {
    #[serde(rename = "employees", skip_serializing_if = "Option::is_none")]
    pub employees: Option<Vec<crate::models::ApiV1EmployeeIndexSerializer>>,
    /// 合計件数
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl ApiV1EmployeesControllerPeriodIndexResponse {
    pub fn new() -> ApiV1EmployeesControllerPeriodIndexResponse {
