...
pub struct ApiV1EmployeesHealthInsuranceRulesControllerUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesHealthInsuranceRulesControllerUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_health_insurance_rule: crate::models::ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializer) -> ApiV1EmployeesHealthInsuranceRulesControllerUpdateBody {
