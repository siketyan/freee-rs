...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeResponse {
    #[serde(rename = "employees", skip_serializing_if = "Option::is_none")]
    pub employees: Option<Box<crate::models::ApiV1EmployeeYearendAdjustmentEmployeeSerializer>>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeResponse {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeResponse {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeResponse {
            employees: None,
        }
    }
}
