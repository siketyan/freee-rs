...
pub struct ApiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer {
    /// 確定給与額
    #[serde(rename = "fixed_payroll", skip_serializing_if = "Option::is_none")]
    pub fixed_payroll: Option<i32>,
    /// 確定給与控除額
    #[serde(rename = "fixed_payroll_deduction", skip_serializing_if = "Option::is_none")]
    pub fixed_payroll_deduction: Option<i32>,
    /// 確定給与所得税額
    #[serde(rename = "fixed_payroll_income_tax", skip_serializing_if = "Option::is_none")]
    pub fixed_payroll_income_tax: Option<i32>,
    /// 確定賞与額
    #[serde(rename = "fixed_bonus", skip_serializing_if = "Option::is_none")]
    pub fixed_bonus: Option<i32>,
    /// 確定賞与控除額
    #[serde(rename = "fixed_bonus_deduction", skip_serializing_if = "Option::is_none")]
    pub fixed_bonus_deduction: Option<i32>,
    /// 確定賞与所得税額
    #[serde(rename = "fixed_bonus_income_tax", skip_serializing_if = "Option::is_none")]
    pub fixed_bonus_income_tax: Option<i32>,
    /// 未入力給与額
    #[serde(rename = "unentered_payroll_amount", skip_serializing_if = "Option::is_none")]
    pub unentered_payroll_amount: Option<i32>,
    /// 未入力給与控除額
    #[serde(rename = "unentered_payroll_deduction_amount", skip_serializing_if = "Option::is_none")]
    pub unentered_payroll_deduction_amount: Option<i32>,
    /// 未入力給与所得税額
    #[serde(rename = "unentered_payroll_income_tax_amount", skip_serializing_if = "Option::is_none")]
    pub unentered_payroll_income_tax_amount: Option<i32>,
    /// 未入力賞与額
    #[serde(rename = "unentered_bonus_amount", skip_serializing_if = "Option::is_none")]
    pub unentered_bonus_amount: Option<i32>,
    /// 未入力賞与控除額
    #[serde(rename = "unentered_bonus_deduction_amount", skip_serializing_if = "Option::is_none")]
    pub unentered_bonus_deduction_amount: Option<i32>,
    /// 未入力賞与所得税額
    #[serde(rename = "unentered_bonus_income_tax_amount", skip_serializing_if = "Option::is_none")]
    pub unentered_bonus_income_tax_amount: Option<i32>,
}

impl ApiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer {
        ApiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer {
            fixed_payroll: None,
            fixed_payroll_deduction: None,
            fixed_payroll_income_tax: None,
            fixed_bonus: None,
            fixed_bonus_deduction: None,
            fixed_bonus_income_tax: None,
            unentered_payroll_amount: None,
            unentered_payroll_deduction_amount: None,
            unentered_payroll_income_tax_amount: None,
            unentered_bonus_amount: None,
            unentered_bonus_deduction_amount: None,
            unentered_bonus_income_tax_amount: None,
        }
    }
}
