...
pub struct ApiV1ProfileCustomFieldGroupSerializer {
    /// グループ名
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// カスタム項目
    #[serde(rename = "profile_custom_field_rules", skip_serializing_if = "Option::is_none")]
    pub profile_custom_field_rules: Option<Vec<crate::models::ApiV1EmployeeProfileCustomFieldSerializer>>,
}

impl ApiV1ProfileCustomFieldGroupSerializer {
    pub fn new() -> ApiV1ProfileCustomFieldGroupSerializer {
        ApiV1ProfileCustomFieldGroupSerializer {
            name: None,
            profile_custom_field_rules: None,
        }
    }
}
