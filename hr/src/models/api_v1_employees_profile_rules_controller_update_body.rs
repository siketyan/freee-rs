...
pub struct ApiV1EmployeesProfileRulesControllerUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesProfileRulesControllerUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_profile_rule: crate::models::ApiV1EmployeesProfileRuleUpdateRequestSerializer) -> ApiV1EmployeesProfileRulesControllerUpdateBody {
