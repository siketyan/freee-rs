...
pub struct ApiV1BonusesEmployeePayrollStatementsIndexSerializer {
    #[serde(rename = "employee_payroll_statements", skip_serializing_if = "Option::is_none")]
    pub employee_payroll_statements: Option<Vec<crate::models::ApiV1BonusesEmployeePayrollStatementSerializer>>,
    /// 合計件数
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl ApiV1BonusesEmployeePayrollStatementsIndexSerializer {
    pub fn new() -> ApiV1BonusesEmployeePayrollStatementsIndexSerializer {
