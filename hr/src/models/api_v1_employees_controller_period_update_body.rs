...
pub struct ApiV1EmployeesControllerPeriodUpdateBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    /// 更新対象年 - 給与計算対象の従業員情報の場合は必須になります。
    #[serde(rename = "year", skip_serializing_if = "Option::is_none")]
    pub year: Option<i32>,
    /// 更新対象月 - 給与計算対象の従業員情報の場合は必須になります。 - 締日支払日設定が翌月払いの従業員情報の場合は、 指定したmonth + 1の値が更新されます。 - 翌月払いの従業員の2022/01の従業員情報を更新する場合は、year=2021,month=12を指定してください。
    #[serde(rename = "month", skip_serializing_if = "Option::is_none")]
    pub month: Option<i32>,
    #[serde(rename = "employee")]
    pub employee: Box<crate::models::ApiV1EmployeeUpdateRequestSerializer>,
}

impl ApiV1EmployeesControllerPeriodUpdateBody {
    pub fn new(company_id: i32, employee: crate::models::ApiV1EmployeeUpdateRequestSerializer) -> ApiV1EmployeesControllerPeriodUpdateBody {
