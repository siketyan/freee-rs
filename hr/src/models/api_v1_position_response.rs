...
pub struct ApiV1PositionResponse {
    #[serde(rename = "position")]
    pub position: Box<crate::models::ApiV1PositionResponseParams>,
}

impl ApiV1PositionResponse {
    pub fn new(position: crate::models::ApiV1PositionResponseParams) -> ApiV1PositionResponse {
