...
pub struct ApiV1GroupsIndexResponse {
    #[serde(rename = "groups")]
    pub groups: Vec<crate::models::ApiV1GroupResponseParams>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl ApiV1GroupsIndexResponse {
    pub fn new(groups: Vec<crate::models::ApiV1GroupResponseParams>, total_count: i32) -> ApiV1GroupsIndexResponse {
