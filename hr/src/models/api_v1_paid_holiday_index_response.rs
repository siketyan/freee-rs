...
pub struct ApiV1PaidHolidayIndexResponse {
    #[serde(rename = "paid_holidays")]
    pub paid_holidays: Vec<crate::models::ApiV1PaidHolidayIndexResponseParams>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl ApiV1PaidHolidayIndexResponse {
    pub fn new(paid_holidays: Vec<crate::models::ApiV1PaidHolidayIndexResponseParams>, total_count: i32) -> ApiV1PaidHolidayIndexResponse {
