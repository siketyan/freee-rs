...
pub struct ApiV1GroupResponse {
    #[serde(rename = "group")]
    pub group: Box<crate::models::ApiV1GroupResponseParams>,
}

impl ApiV1GroupResponse {
    pub fn new(group: crate::models::ApiV1GroupResponseParams) -> ApiV1GroupResponse {
        ApiV1GroupResponse {
            group: Box::new(group),
        }
    }
