...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateHousingLoanBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "housing_loan")]
    pub housing_loan: Box<crate::models::ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateHousingLoanBody {
    pub fn new(company_id: i32, housing_loan: crate::models::ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer) -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateHousingLoanBody {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateHousingLoanBody {
            company_id,
            housing_loan: Box::new(housing_loan),
        }
    }
}
