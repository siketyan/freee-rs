...
pub struct ApiV1EmployeesTimeClocksControllerPeriodCreateBody {
    /// (required)
...
impl ApiV1EmployeesTimeClocksControllerPeriodCreateBody {
    pub fn new(company_id: i32, r#type: RHashType) -> ApiV1EmployeesTimeClocksControllerPeriodCreateBody {
