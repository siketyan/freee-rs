...
pub struct ApiV1EmployeesControllerPeriodCreateBody {
    /// 作成対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "employee")]
    pub employee: Box<crate::models::ApiV1EmployeeCreateRequestSerializer>,
}

impl ApiV1EmployeesControllerPeriodCreateBody {
    pub fn new(company_id: i32, employee: crate::models::ApiV1EmployeeCreateRequestSerializer) -> ApiV1EmployeesControllerPeriodCreateBody {
