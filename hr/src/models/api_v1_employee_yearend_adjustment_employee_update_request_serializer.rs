...
pub struct ApiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer {
    /// 姓 null不可
    ...
    /// 住民票住所の郵便番号1
    #[serde(rename = "zipcode1")]
    pub zipcode1: String,
    /// 住民票住所の郵便番号2
    #[serde(rename = "zipcode2")]
    pub zipcode2: String,
...
impl ApiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer {
    pub fn new(last_name: String, first_name: String, last_name_kana: String, first_name_kana: String, zipcode1: String, zipcode2: String, prefecture_code: i32, address: String) -> ApiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer {
