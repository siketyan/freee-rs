...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePayrollAndBonusBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "payroll_and_bonus")]
    pub payroll_and_bonus: Box<crate::models::ApiV1EmployeeYearendAdjustmentPayrollAndBonusUpdateRequestSerializer>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePayrollAndBonusBody {
    pub fn new(company_id: i32, payroll_and_bonus: crate::models::ApiV1EmployeeYearendAdjustmentPayrollAndBonusUpdateRequestSerializer) -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePayrollAndBonusBody {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePayrollAndBonusBody {
            company_id,
            payroll_and_bonus: Box::new(payroll_and_bonus),
        }
    }
}
