...
pub struct ApiV1specialHolidayRequest {
    /// 事業所ID（必須）
...
impl ApiV1specialHolidayRequest {
    pub fn new(company_id: i32, target_date: String, special_holiday_setting_id: i32, holiday_type: HolidayType, approval_flow_route_id: i32) -> ApiV1specialHolidayRequest {
