...
pub struct ApiV1EmployeesDependentRulesControllerPeriodBulkUpdateResponse {
    /// 扶養親族ルール
...
impl ApiV1EmployeesDependentRulesControllerPeriodBulkUpdateResponse {
    pub fn new() -> ApiV1EmployeesDependentRulesControllerPeriodBulkUpdateResponse {
