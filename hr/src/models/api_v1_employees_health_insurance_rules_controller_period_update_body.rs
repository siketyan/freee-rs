...
pub struct ApiV1EmployeesHealthInsuranceRulesControllerPeriodUpdateBody {
    /// 更新対象事業所ID（必須）
    ...
    #[serde(rename = "month")]
    pub month: i32,
    #[serde(rename = "employee_health_insurance_rule")]
    pub employee_health_insurance_rule: Box<crate::models::ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializer>,
}

impl ApiV1EmployeesHealthInsuranceRulesControllerPeriodUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_health_insurance_rule: crate::models::ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializer) -> ApiV1EmployeesHealthInsuranceRulesControllerPeriodUpdateBody {
        ApiV1EmployeesHealthInsuranceRulesControllerPeriodUpdateBody {
            company_id,
            year,
            month,
            employee_health_insurance_rule: Box::new(employee_health_insurance_rule),
        }
    }
}
