...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateInsuranceBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "insurance")]
    pub insurance: Box<crate::models::ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateInsuranceBody {
    pub fn new(company_id: i32, insurance: crate::models::ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer) -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateInsuranceBody {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateInsuranceBody {
            company_id,
