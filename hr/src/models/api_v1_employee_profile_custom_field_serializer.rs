...
pub struct ApiV1EmployeeProfileCustomFieldSerializer {
    ...
    /// ファイルID（項目タイプがfile以外の場合、nullを返します）
...
impl ApiV1EmployeeProfileCustomFieldSerializer {
    pub fn new() -> ApiV1EmployeeProfileCustomFieldSerializer {
