...
pub struct ApiV1MonthlyAttendanceCreateRequest {
    /// 事業所ID（必須）
...
impl ApiV1MonthlyAttendanceCreateRequest {
    pub fn new(company_id: i32, target_year: i32, target_month: i32, approval_flow_route_id: i32) -> ApiV1MonthlyAttendanceCreateRequest {
