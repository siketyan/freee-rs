...
pub struct ApiV1GroupCreateRequest {
    /// 作成対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "group")]
    pub group: Box<crate::models::ApiV1GroupCreateRequestParams>,
}

impl ApiV1GroupCreateRequest {
    pub fn new(company_id: i32, group: crate::models::ApiV1GroupCreateRequestParams) -> ApiV1GroupCreateRequest {
