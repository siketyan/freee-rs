...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "previous_job")]
    pub previous_job: Box<crate::models::ApiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobBody {
    pub fn new(company_id: i32, previous_job: crate::models::ApiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer) -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobBody {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobBody {
            company_id,
            previous_job: Box::new(previous_job),
        }
    }
}
