...
pub struct ApiV1EmployeeGroupMembershipsIndexSerializer {
    #[serde(rename = "employee_group_memberships", skip_serializing_if = "Option::is_none")]
    pub employee_group_memberships: Option<Vec<crate::models::ApiV1EmployeeGroupMembershipSerializer>>,
    /// 合計件数
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl ApiV1EmployeeGroupMembershipsIndexSerializer {
    pub fn new() -> ApiV1EmployeeGroupMembershipsIndexSerializer {
        ApiV1EmployeeGroupMembershipsIndexSerializer {
            employee_group_memberships: None,
            total_count: None,
        }
    }
}
