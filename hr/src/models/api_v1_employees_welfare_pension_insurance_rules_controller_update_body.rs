...
pub struct ApiV1EmployeesWelfarePensionInsuranceRulesControllerUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesWelfarePensionInsuranceRulesControllerUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_welfare_pension_insurance_rule: crate::models::ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializer) -> ApiV1EmployeesWelfarePensionInsuranceRulesControllerUpdateBody {
