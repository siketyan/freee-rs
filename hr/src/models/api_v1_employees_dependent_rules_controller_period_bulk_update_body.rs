...
pub struct ApiV1EmployeesDependentRulesControllerPeriodBulkUpdateBody {
    /// 更新対象事業所ID（必須）
    ...
    pub month: i32,
    /// 家族情報ルール
    #[serde(rename = "employee_dependent_rules")]
    pub employee_dependent_rules: Vec<crate::models::ApiV1EmployeesDependentRuleUpdateRequestSerializer>,
}

impl ApiV1EmployeesDependentRulesControllerPeriodBulkUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_dependent_rules: Vec<crate::models::ApiV1EmployeesDependentRuleUpdateRequestSerializer>) -> ApiV1EmployeesDependentRulesControllerPeriodBulkUpdateBody {
