...
pub struct ApiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer {
    /// 時給名
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// 所定内労働時間（分）
    #[serde(rename = "total_normal_time_mins", skip_serializing_if = "Option::is_none")]
    pub total_normal_time_mins: Option<i32>,
}

impl ApiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer {
    pub fn new() -> ApiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer {
        ApiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer {
            name: None,
            total_normal_time_mins: None,
        }
    }
}
