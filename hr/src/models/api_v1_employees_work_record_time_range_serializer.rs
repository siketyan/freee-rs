...
pub struct ApiV1EmployeesWorkRecordTimeRangeSerializer {
    /// 開始時刻
...
impl ApiV1EmployeesWorkRecordTimeRangeSerializer {
    pub fn new(clock_in_at: String, clock_out_at: String) -> ApiV1EmployeesWorkRecordTimeRangeSerializer {
