...
pub struct ApiV1WorkTimeIndexResponseParams {
    /// 申請ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
    ...
    /// 承認者のユーザーID配列 次の場合、空配列になります。 - 指定なしの申請経路を利用した、申請ステータスが承認済み以外の申請 - 申請が差戻された
    ...
    #[serde(rename = "clear_work_time")]
    pub clear_work_time: bool,
    /// 勤務開始時間
    ...
    /// 遅刻分の時間（分単位）
    #[serde(rename = "lateness_mins")]
    pub lateness_mins: i32,
    /// 早退分の時間（分単位）
    #[serde(rename = "early_leaving_mins")]
    pub early_leaving_mins: i32,
    /// 休憩時間のリスト
    #[serde(rename = "break_records", skip_serializing_if = "Option::is_none")]
    pub break_records: Option<Vec<crate::models::ApiV1WorkTimeIndexResponseParamsBreakRecordsInner>>,
    /// 申請日
...
impl ApiV1WorkTimeIndexResponseParams {
    pub fn new(id: i32, company_id: i32, application_number: i32, applicant_id: i32, target_date: String, clear_work_time: bool, lateness_mins: i32, early_leaving_mins: i32, issue_date: String, status: Status, passed_auto_check: bool) -> ApiV1WorkTimeIndexResponseParams {
