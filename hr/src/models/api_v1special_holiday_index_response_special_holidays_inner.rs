...
pub struct ApiV1specialHolidayIndexResponseSpecialHolidaysInner {
    /// 申請ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
    ...
    /// 特別休暇設定ID
    #[serde(rename = "special_holiday_setting_id")]
    pub special_holiday_setting_id: i32,
    /// 特別休暇名称
    #[serde(rename = "special_holiday_name")]
    pub special_holiday_name: String,
...
impl ApiV1specialHolidayIndexResponseSpecialHolidaysInner {
    pub fn new(id: i32, company_id: i32, application_number: i32, applicant_id: i32, target_date: String, special_holiday_setting_id: i32, special_holiday_name: String, holiday_type: HolidayType, issue_date: String, status: Status, revoke_status: Option<RevokeStatus>, passed_auto_check: bool) -> ApiV1specialHolidayIndexResponseSpecialHolidaysInner {
        ApiV1specialHolidayIndexResponseSpecialHolidaysInner {
            id,
            company_id,
            application_number,
