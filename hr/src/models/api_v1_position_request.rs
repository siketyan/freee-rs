...
pub struct ApiV1PositionRequest {
    /// 作成対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "position")]
    pub position: Box<crate::models::ApiV1PositionRequestParams>,
}

impl ApiV1PositionRequest {
    pub fn new(company_id: i32, position: crate::models::ApiV1PositionRequestParams) -> ApiV1PositionRequest {
