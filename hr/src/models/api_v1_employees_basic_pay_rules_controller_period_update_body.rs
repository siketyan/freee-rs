...
pub struct ApiV1EmployeesBasicPayRulesControllerPeriodUpdateBody {
    /// 更新対象事業所ID（必須）
    ...
    #[serde(rename = "month")]
    pub month: i32,
    #[serde(rename = "employee_basic_pay_rule")]
    pub employee_basic_pay_rule: Box<crate::models::ApiV1EmployeesBasicPayRuleUpdateRequestSerializer>,
}

impl ApiV1EmployeesBasicPayRulesControllerPeriodUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_basic_pay_rule: crate::models::ApiV1EmployeesBasicPayRuleUpdateRequestSerializer) -> ApiV1EmployeesBasicPayRulesControllerPeriodUpdateBody {
        ApiV1EmployeesBasicPayRulesControllerPeriodUpdateBody {
            company_id,
            year,
            month,
            employee_basic_pay_rule: Box::new(employee_basic_pay_rule),
        }
    }
}
