...
pub struct ApiV1BonusesEmployeePayrollStatementsControllerPeriodShowResponse {
    #[serde(rename = "employee_payroll_statement", skip_serializing_if = "Option::is_none")]
    pub employee_payroll_statement: Option<Box<crate::models::ApiV1BonusesEmployeePayrollStatementSerializer>>,
}

impl ApiV1BonusesEmployeePayrollStatementsControllerPeriodShowResponse {
    pub fn new() -> ApiV1BonusesEmployeePayrollStatementsControllerPeriodShowResponse {
