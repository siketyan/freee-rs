...
pub struct ApiV1WorkTimeIndexResponseParamsBreakRecordsInner {
    /// 開始時刻
    #[serde(rename = "clock_in_at")]
    pub clock_in_at: String,
    /// 終了時刻
    #[serde(rename = "clock_out_at")]
    pub clock_out_at: String,
}

impl ApiV1WorkTimeIndexResponseParamsBreakRecordsInner {
    pub fn new(clock_in_at: String, clock_out_at: String) -> ApiV1WorkTimeIndexResponseParamsBreakRecordsInner {
        ApiV1WorkTimeIndexResponseParamsBreakRecordsInner {
            clock_in_at,
            clock_out_at,
        }
    }
