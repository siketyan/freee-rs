...
pub struct ApiV1SalariesEmployeePayrollStatementsControllerPeriodIndexResponse {
    #[serde(rename = "employee_payroll_statements", skip_serializing_if = "Option::is_none")]
    pub employee_payroll_statements: Option<Vec<crate::models::ApiV1SalariesEmployeePayrollStatementSerializer>>,
}

impl ApiV1SalariesEmployeePayrollStatementsControllerPeriodIndexResponse {
    pub fn new() -> ApiV1SalariesEmployeePayrollStatementsControllerPeriodIndexResponse {
        ApiV1SalariesEmployeePayrollStatementsControllerPeriodIndexResponse {
            employee_payroll_statements: None,
        }
    }
}
