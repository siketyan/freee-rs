...
pub struct ApiV1specialHolidayIndexResponse {
    #[serde(rename = "special_holidays")]
    pub special_holidays: Vec<crate::models::ApiV1specialHolidayIndexResponseSpecialHolidaysInner>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl ApiV1specialHolidayIndexResponse {
    pub fn new(special_holidays: Vec<crate::models::ApiV1specialHolidayIndexResponseSpecialHolidaysInner>, total_count: i32) -> ApiV1specialHolidayIndexResponse {
