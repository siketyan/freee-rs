...
pub struct GetApprovalRequestsWorkTimes200Response {
    #[serde(rename = "work_times")]
    pub work_times: Vec<crate::models::ApiV1WorkTimeIndexResponseParams>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl GetApprovalRequestsWorkTimes200Response {
    pub fn new(work_times: Vec<crate::models::ApiV1WorkTimeIndexResponseParams>, total_count: i32) -> GetApprovalRequestsWorkTimes200Response {
        GetApprovalRequestsWorkTimes200Response {
            work_times,
            total_count,
        }
    }
