...
pub struct ApiV1MonthlyAttendanceIndexResponse {
    #[serde(rename = "monthly_attendances")]
    pub monthly_attendances: Vec<crate::models::ApiV1MonthlyAttendanceIndexResponseParams>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl ApiV1MonthlyAttendanceIndexResponse {
    pub fn new(monthly_attendances: Vec<crate::models::ApiV1MonthlyAttendanceIndexResponseParams>, total_count: i32) -> ApiV1MonthlyAttendanceIndexResponse {
