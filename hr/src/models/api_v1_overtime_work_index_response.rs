...
pub struct ApiV1OvertimeWorkIndexResponse {
    #[serde(rename = "overtime_works")]
    pub overtime_works: Vec<crate::models::ApiV1OvertimeWorkIndexResponseParams>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl ApiV1OvertimeWorkIndexResponse {
    pub fn new(overtime_works: Vec<crate::models::ApiV1OvertimeWorkIndexResponseParams>, total_count: i32) -> ApiV1OvertimeWorkIndexResponse {
