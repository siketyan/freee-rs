...
pub struct ApiV1GroupUpdateRequest {
    /// 作成対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "group")]
    pub group: Box<crate::models::ApiV1GroupUpdateRequestParams>,
}

impl ApiV1GroupUpdateRequest {
    pub fn new(company_id: i32, group: crate::models::ApiV1GroupUpdateRequestParams) -> ApiV1GroupUpdateRequest {
