...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodShowResponse {
    #[serde(rename = "employee", skip_serializing_if = "Option::is_none")]
    pub employee: Option<Box<crate::models::ApiV1EmployeeYearendAdjustmentEmployeeSerializer>>,
    /// 家族情報(年末調整対象外の場合は取得できません。)
    #[serde(rename = "dependents", skip_serializing_if = "Option::is_none")]
    pub dependents: Option<Vec<crate::models::ApiV1EmployeeYearendAdjustmentDependentSerializer>>,
    /// 保険料情報(年末調整対象外の場合は取得できません。)
    #[serde(rename = "insurances", skip_serializing_if = "Option::is_none")]
    pub insurances: Option<Vec<crate::models::ApiV1EmployeeYearendAdjustmentInsuranceSerializer>>,
    /// 住宅借入金等特別控除(年末調整対象外の場合は取得できません。)
    #[serde(rename = "housing_loan_deduction", skip_serializing_if = "Option::is_none")]
    pub housing_loan_deduction: Option<i32>,
    /// 住宅ローン(年末調整対象外の場合は取得できません。)
    #[serde(rename = "housing_loans", skip_serializing_if = "Option::is_none")]
    pub housing_loans: Option<Vec<crate::models::ApiV1EmployeeYearendAdjustmentHousingLoanSerializer>>,
    #[serde(rename = "payroll_and_bonus", skip_serializing_if = "Option::is_none")]
    pub payroll_and_bonus: Option<Box<crate::models::ApiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer>>,
    #[serde(rename = "previous_job", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub previous_job: Option<Option<Box<crate::models::ApiV1EmployeeYearendAdjustmentPreviousJobSerializer>>>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodShowResponse {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentControllerPeriodShowResponse {
        ApiV1EmployeeYearendAdjustmentControllerPeriodShowResponse {
            employee: None,
            dependents: None,
            insurances: None,
            housing_loan_deduction: None,
            housing_loans: None,
            payroll_and_bonus: None,
            previous_job: None,
        }
    }
}
