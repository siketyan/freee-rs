...
pub struct ApiV1MonthlyAttendanceUpdateRequest {
    /// 事業所ID（必須）
...
impl ApiV1MonthlyAttendanceUpdateRequest {
    pub fn new(company_id: i32, approval_flow_route_id: i32) -> ApiV1MonthlyAttendanceUpdateRequest {
