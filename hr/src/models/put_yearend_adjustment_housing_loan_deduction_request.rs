...
pub struct PutYearendAdjustmentHousingLoanDeductionRequest {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    /// 住宅借入金等特別控除（必須）
    #[serde(rename = "housing_loan_deduction")]
    pub housing_loan_deduction: i32,
}

impl PutYearendAdjustmentHousingLoanDeductionRequest {
    pub fn new(company_id: i32, housing_loan_deduction: i32) -> PutYearendAdjustmentHousingLoanDeductionRequest {
        PutYearendAdjustmentHousingLoanDeductionRequest {
            company_id,
