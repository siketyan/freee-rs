...
pub struct ApiV1OvertimeWorkRequest {
    /// 事業所ID（必須）
...
impl ApiV1OvertimeWorkRequest {
    pub fn new(company_id: i32, target_date: String, start_at: String, end_at: String, approval_flow_route_id: i32) -> ApiV1OvertimeWorkRequest {
