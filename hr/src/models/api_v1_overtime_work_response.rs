...
pub struct ApiV1OvertimeWorkResponse {
    #[serde(rename = "overtime_work")]
    pub overtime_work: Box<crate::models::ApiV1OvertimeWorkResponseParams>,
}

impl ApiV1OvertimeWorkResponse {
    pub fn new(overtime_work: crate::models::ApiV1OvertimeWorkResponseParams) -> ApiV1OvertimeWorkResponse {
        ApiV1OvertimeWorkResponse {
            overtime_work: Box::new(overtime_work),
        }
    }
}
