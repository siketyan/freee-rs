...
pub struct ApiV1EmployeesControllerCreateBody {
    /// 作成対象事業所ID（必須）
...
impl ApiV1EmployeesControllerCreateBody {
    pub fn new(company_id: i32, employee: crate::models::ApiV1EmployeeCreateRequestSerializer) -> ApiV1EmployeesControllerCreateBody {
