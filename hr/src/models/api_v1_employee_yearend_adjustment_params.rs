...
pub struct ApiV1EmployeeYearendAdjustmentParams {
    /// 従業員ID
    ...
    /// 年末調整対象外 - true - 年末調整対象外 - false - 年末調整対象
    #[serde(rename = "is_not_adjust", skip_serializing_if = "Option::is_none")]
    pub is_not_adjust: Option<bool>,
    /// 年末調整ステータス - initialized - 入力依頼前 - in_employee_progress - 従業員入力中 - submitted - 従業員入力済 - fixed - 確定
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
}

impl ApiV1EmployeeYearendAdjustmentParams {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentParams {
...
pub enum Status {
    ...
    Initialized,
    #[serde(rename = "in_employee_progress")]
    InEmployeeProgress,
