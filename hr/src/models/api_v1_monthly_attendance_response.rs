...
pub struct ApiV1MonthlyAttendanceResponse {
    #[serde(rename = "monthly_attendance")]
    pub monthly_attendance: Box<crate::models::ApiV1MonthlyAttendanceResponseParams>,
}

impl ApiV1MonthlyAttendanceResponse {
    pub fn new(monthly_attendance: crate::models::ApiV1MonthlyAttendanceResponseParams) -> ApiV1MonthlyAttendanceResponse {
        ApiV1MonthlyAttendanceResponse {
            monthly_attendance: Box::new(monthly_attendance),
        }
    }
}
