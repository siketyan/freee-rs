...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobResponse {
...
impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobResponse {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobResponse {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdatePreviousJobResponse {
            previous_job: None,
        }
    }
}
