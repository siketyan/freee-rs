...
/// GetEmployeesSpecialHolidays200ResponseEmployeeSpecialHolidaysInnerNumDaysAndHoursUsed : 使用日数・時間数



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetEmployeesSpecialHolidays200ResponseEmployeeSpecialHolidaysInnerNumDaysAndHoursUsed {
    /// 日数
...
impl GetEmployeesSpecialHolidays200ResponseEmployeeSpecialHolidaysInnerNumDaysAndHoursUsed {
    /// 使用日数・時間数
    pub fn new() -> GetEmployeesSpecialHolidays200ResponseEmployeeSpecialHolidaysInnerNumDaysAndHoursUsed {
        GetEmployeesSpecialHolidays200ResponseEmployeeSpecialHolidaysInnerNumDaysAndHoursUsed {
            days: None,
            hours: None,
        }
    }
