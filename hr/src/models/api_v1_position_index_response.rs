...
pub struct ApiV1PositionIndexResponse {
    #[serde(rename = "positions")]
    pub positions: Vec<crate::models::ApiV1PositionResponseParams>,
    /// 合計件数
    #[serde(rename = "total_count")]
    pub total_count: i32,
}

impl ApiV1PositionIndexResponse {
    pub fn new(positions: Vec<crate::models::ApiV1PositionResponseParams>, total_count: i32) -> ApiV1PositionIndexResponse {
