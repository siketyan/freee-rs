...
pub struct ApiV1EmployeePayrollStatementsEmployeeAttendanceItemSerializer {
    /// 項目名
...
impl ApiV1EmployeePayrollStatementsEmployeeAttendanceItemSerializer {
    pub fn new() -> ApiV1EmployeePayrollStatementsEmployeeAttendanceItemSerializer {
