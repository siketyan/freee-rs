...
pub struct ApiV1EmployeesBankAccountRulesControllerPeriodUpdateBody {
    /// 更新対象事業所ID（必須）
    ...
    #[serde(rename = "month")]
    pub month: i32,
    #[serde(rename = "employee_bank_account_rule")]
    pub employee_bank_account_rule: Box<crate::models::ApiV1EmployeesBankAccountRuleUpdateRequestSerializer>,
}

impl ApiV1EmployeesBankAccountRulesControllerPeriodUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_bank_account_rule: crate::models::ApiV1EmployeesBankAccountRuleUpdateRequestSerializer) -> ApiV1EmployeesBankAccountRulesControllerPeriodUpdateBody {
        ApiV1EmployeesBankAccountRulesControllerPeriodUpdateBody {
            company_id,
            year,
            month,
            employee_bank_account_rule: Box::new(employee_bank_account_rule),
        }
    }
}
