...
pub struct ApiV1WorkTimeResponseParams {
    /// 申請ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
    ...
    pub break_records: Option<Vec<crate::models::Items>>,
    /// 申請日
...
impl ApiV1WorkTimeResponseParams {
    pub fn new(id: i32, company_id: i32, application_number: i32, applicant_id: i32, target_date: String, clear_work_time: bool, lateness_mins: i32, early_leaving_mins: i32, issue_date: String, status: Status, passed_auto_check: bool, approval_flow_route_id: i32, approval_flow_route_name: String, approval_flow_logs: Vec<crate::models::ApiV1ApprovalFlowLogsParams>, current_round: i32) -> ApiV1WorkTimeResponseParams {
