...
pub struct ApiV1EmployeesBankAccountRulesControllerUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesBankAccountRulesControllerUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_bank_account_rule: crate::models::ApiV1EmployeesBankAccountRuleUpdateRequestSerializer) -> ApiV1EmployeesBankAccountRulesControllerUpdateBody {
