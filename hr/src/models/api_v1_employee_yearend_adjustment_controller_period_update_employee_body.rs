...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    #[serde(rename = "employee")]
    pub employee: Box<crate::models::ApiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeBody {
    pub fn new(company_id: i32, employee: crate::models::ApiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer) -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeBody {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateEmployeeBody {
            company_id,
