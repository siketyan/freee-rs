...
pub struct ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer {
    /// 居住開始の年月日 2000年1月1日から現在年+5の12月31日まで登録可能
    #[serde(rename = "residence_start_date")]
    pub residence_start_date: String,
    /// 住宅借入金等年末残高
    #[serde(rename = "remaining_balance_at_yearend")]
    pub remaining_balance_at_yearend: i32,
    ...
    #[serde(rename = "specific_case_type")]
    pub specific_case_type: SpecificCaseType,
}

impl ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer {
    pub fn new(residence_start_date: String, remaining_balance_at_yearend: i32, category: Category, specific_case_type: SpecificCaseType) -> ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer {
