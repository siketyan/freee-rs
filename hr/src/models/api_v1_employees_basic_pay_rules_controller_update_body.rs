...
pub struct ApiV1EmployeesBasicPayRulesControllerUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesBasicPayRulesControllerUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_basic_pay_rule: crate::models::ApiV1EmployeesBasicPayRuleUpdateRequestSerializer) -> ApiV1EmployeesBasicPayRulesControllerUpdateBody {
