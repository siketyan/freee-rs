...
pub struct ApiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer {
    /// 前職の支払金額
    #[serde(rename = "income")]
    pub income: i32,
    /// 前職の社会保険料等の金額
    ...
    pub deduction: i32,
    /// 前職の源泉徴収額
    #[serde(rename = "withholding_tax_amount")]
    pub withholding_tax_amount: i32,
    /// 前職の社名
    ...
    #[serde(rename = "retire_date")]
    pub retire_date: String,
}

impl ApiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer {
    pub fn new(income: i32, deduction: i32, withholding_tax_amount: i32, company_name: String, company_address: String, retire_date: String) -> ApiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer {
