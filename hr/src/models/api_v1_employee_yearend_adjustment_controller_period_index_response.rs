...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodIndexResponse {
    #[serde(rename = "employees", skip_serializing_if = "Option::is_none")]
    pub employees: Option<Vec<crate::models::ApiV1EmployeeYearendAdjustmentParams>>,
    /// 合計件数
    #[serde(rename = "total_count", skip_serializing_if = "Option::is_none")]
    pub total_count: Option<i32>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodIndexResponse {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentControllerPeriodIndexResponse {
        ApiV1EmployeeYearendAdjustmentControllerPeriodIndexResponse {
            employees: None,
            total_count: None,
        }
    }
