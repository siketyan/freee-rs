...
pub struct ApiV1PaidHolidayResponse {
    #[serde(rename = "paid_holiday")]
    pub paid_holiday: Box<crate::models::ApiV1PaidHolidayResponseParams>,
}

impl ApiV1PaidHolidayResponse {
    pub fn new(paid_holiday: crate::models::ApiV1PaidHolidayResponseParams) -> ApiV1PaidHolidayResponse {
        ApiV1PaidHolidayResponse {
            paid_holiday: Box::new(paid_holiday),
        }
    }
}
