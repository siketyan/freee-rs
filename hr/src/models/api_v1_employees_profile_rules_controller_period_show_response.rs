...
pub struct ApiV1EmployeesProfileRulesControllerPeriodShowResponse {
...
impl ApiV1EmployeesProfileRulesControllerPeriodShowResponse {
    pub fn new() -> ApiV1EmployeesProfileRulesControllerPeriodShowResponse {
        ApiV1EmployeesProfileRulesControllerPeriodShowResponse {
            employee_profile_rule: None,
        }
    }
}
