...
pub struct ApiV1specialHolidayResponse {
    #[serde(rename = "special_holiday")]
    pub special_holiday: Box<crate::models::ApiV1specialHolidayResponseSpecialHoliday>,
}

impl ApiV1specialHolidayResponse {
    pub fn new(special_holiday: crate::models::ApiV1specialHolidayResponseSpecialHoliday) -> ApiV1specialHolidayResponse {
        ApiV1specialHolidayResponse {
            special_holiday: Box::new(special_holiday),
        }
    }
}
