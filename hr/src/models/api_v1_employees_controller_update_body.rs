...
pub struct ApiV1EmployeesControllerUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesControllerUpdateBody {
    pub fn new(company_id: i32, employee: crate::models::ApiV1EmployeeUpdateRequestSerializer) -> ApiV1EmployeesControllerUpdateBody {
