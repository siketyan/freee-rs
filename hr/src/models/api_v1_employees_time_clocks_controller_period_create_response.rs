...
pub struct ApiV1EmployeesTimeClocksControllerPeriodCreateResponse {
    #[serde(rename = "employee_time_clock", skip_serializing_if = "Option::is_none")]
    pub employee_time_clock: Option<Box<crate::models::ApiV1EmployeesTimeClockSerializer>>,
}

impl ApiV1EmployeesTimeClocksControllerPeriodCreateResponse {
    pub fn new() -> ApiV1EmployeesTimeClocksControllerPeriodCreateResponse {
        ApiV1EmployeesTimeClocksControllerPeriodCreateResponse {
            employee_time_clock: None,
        }
    }
}
