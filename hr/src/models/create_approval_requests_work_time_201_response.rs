...
pub struct CreateApprovalRequestsWorkTime201Response {
    #[serde(rename = "work_time")]
    pub work_time: Box<crate::models::ApiV1WorkTimeResponseParams>,
}

impl CreateApprovalRequestsWorkTime201Response {
    pub fn new(work_time: crate::models::ApiV1WorkTimeResponseParams) -> CreateApprovalRequestsWorkTime201Response {
        CreateApprovalRequestsWorkTime201Response {
            work_time: Box::new(work_time),
        }
    }
}
