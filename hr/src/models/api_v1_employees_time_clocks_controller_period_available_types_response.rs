...
pub struct ApiV1EmployeesTimeClocksControllerPeriodAvailableTypesResponse {
    /// 打刻可能種別
    #[serde(rename = "available_types", skip_serializing_if = "Option::is_none")]
    pub available_types: Option<Vec<AvailableTypes>>,
    /// 打刻基準日
    #[serde(rename = "base_date", skip_serializing_if = "Option::is_none")]
    pub base_date: Option<String>,
}

impl ApiV1EmployeesTimeClocksControllerPeriodAvailableTypesResponse {
    pub fn new() -> ApiV1EmployeesTimeClocksControllerPeriodAvailableTypesResponse {
...
impl Default for AvailableTypes {
    fn default() -> AvailableTypes {
        Self::ClockIn
    }
}
