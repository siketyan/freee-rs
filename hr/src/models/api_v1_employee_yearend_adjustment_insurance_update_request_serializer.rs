...
pub struct ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer {
    ...
    #[serde(rename = "new_or_old")]
    pub new_or_old: NewOrOld,
...
impl ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer {
    pub fn new(r#type: Type, category: Category, new_or_old: NewOrOld, amount: i32) -> ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer {
