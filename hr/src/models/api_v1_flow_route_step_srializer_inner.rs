...
pub struct ApiV1FlowRouteStepSrializerInner {
    /// 承認ステップID
    #[serde(rename = "id")]
    pub id: i32,
    /// 次の承認ステップID
...
impl ApiV1FlowRouteStepSrializerInner {
    pub fn new(id: i32, next_step_id: Option<i32>, resource_type: ResourceType) -> ApiV1FlowRouteStepSrializerInner {
