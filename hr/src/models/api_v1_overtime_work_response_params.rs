...
pub struct ApiV1OvertimeWorkResponseParams {
    /// 申請ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 事業所ID
...
impl ApiV1OvertimeWorkResponseParams {
    pub fn new(id: i32, company_id: i32, application_number: i32, applicant_id: i32, target_date: String, start_at: String, end_at: String, issue_date: String, status: Status, revoke_status: Option<RevokeStatus>, passed_auto_check: bool, approval_flow_route_id: i32, approval_flow_route_name: String, approval_flow_logs: Vec<crate::models::ApiV1ApprovalFlowLogsParams>, current_round: i32) -> ApiV1OvertimeWorkResponseParams {
