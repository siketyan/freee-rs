...
pub struct ApiV1EmployeesBasicPayRuleUpdateRequestSerializer {
    /// 給与方式 null不可 monthly: 月給, daily: 日給, hourly: 時給
    #[serde(rename = "pay_calc_type")]
    pub pay_calc_type: PayCalcType,
    /// 基本給 null不可
    #[serde(rename = "pay_amount")]
    pub pay_amount: i32,
}

impl ApiV1EmployeesBasicPayRuleUpdateRequestSerializer {
    pub fn new(pay_calc_type: PayCalcType, pay_amount: i32) -> ApiV1EmployeesBasicPayRuleUpdateRequestSerializer {
