...
pub struct ApiV1EmployeesDependentRulesControllerBulkUpdateBody {
    /// 更新対象事業所ID（必須）
...
impl ApiV1EmployeesDependentRulesControllerBulkUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_dependent_rules: Vec<crate::models::ApiV1EmployeesDependentRuleUpdateRequestSerializer>) -> ApiV1EmployeesDependentRulesControllerBulkUpdateBody {
