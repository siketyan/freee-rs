...
pub struct ApiV1ApprovalFlowRoutesIndexResponse {
    #[serde(rename = "approval_flow_routes")]
    pub approval_flow_routes: Vec<crate::models::ApiV1ApprovalFlowRouteIndexResponseParams>,
}

impl ApiV1ApprovalFlowRoutesIndexResponse {
    pub fn new(approval_flow_routes: Vec<crate::models::ApiV1ApprovalFlowRouteIndexResponseParams>) -> ApiV1ApprovalFlowRoutesIndexResponse {
