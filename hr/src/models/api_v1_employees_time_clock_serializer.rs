...
pub struct ApiV1EmployeesTimeClockSerializer {
    /// 打刻ID
    ...
    /// オリジナルの打刻時間
    #[serde(rename = "original_datetime", skip_serializing_if = "Option::is_none")]
...
impl ApiV1EmployeesTimeClockSerializer {
    pub fn new() -> ApiV1EmployeesTimeClockSerializer {
