...
pub struct ApiV1EmployeeYearendAdjustmentDependentSerializer {
    /// 家族情報ID
    ...
    pub social_insurance_and_tax_dependent: Option<SocialInsuranceAndTaxDependent>,
...
impl ApiV1EmployeeYearendAdjustmentDependentSerializer {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentDependentSerializer {
