...
pub struct ApiV1EmployeesTimeClocksControllerAvailableTypesResponse {
    /// 打刻可能種別
...
impl ApiV1EmployeesTimeClocksControllerAvailableTypesResponse {
    pub fn new() -> ApiV1EmployeesTimeClocksControllerAvailableTypesResponse {
