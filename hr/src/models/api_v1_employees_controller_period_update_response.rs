...
pub struct ApiV1EmployeesControllerPeriodUpdateResponse {
    #[serde(rename = "employee", skip_serializing_if = "Option::is_none")]
    pub employee: Option<Box<crate::models::ApiV1EmployeeSerializer>>,
}

impl ApiV1EmployeesControllerPeriodUpdateResponse {
    pub fn new() -> ApiV1EmployeesControllerPeriodUpdateResponse {
