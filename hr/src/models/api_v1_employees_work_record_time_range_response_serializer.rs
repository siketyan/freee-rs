...
pub struct ApiV1EmployeesWorkRecordTimeRangeResponseSerializer {
    /// 開始時刻
...
impl ApiV1EmployeesWorkRecordTimeRangeResponseSerializer {
    pub fn new() -> ApiV1EmployeesWorkRecordTimeRangeResponseSerializer {
