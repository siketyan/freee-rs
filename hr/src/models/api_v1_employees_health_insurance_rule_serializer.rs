...
pub struct ApiV1EmployeesHealthInsuranceRuleSerializer {
    /// 健康保険ルールID
...
impl ApiV1EmployeesHealthInsuranceRuleSerializer {
    pub fn new() -> ApiV1EmployeesHealthInsuranceRuleSerializer {
