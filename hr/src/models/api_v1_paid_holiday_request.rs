...
pub struct ApiV1PaidHolidayRequest {
    /// 事業所ID（必須）
...
impl ApiV1PaidHolidayRequest {
    pub fn new(company_id: i32, target_date: String, holiday_type: HolidayType, approval_flow_route_id: i32) -> ApiV1PaidHolidayRequest {
