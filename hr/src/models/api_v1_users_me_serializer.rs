...
pub struct ApiV1UsersMeSerializer {
    /// ユーザーID
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i32>,
    /// ユーザーが属する事業所の一覧
    #[serde(rename = "companies", skip_serializing_if = "Option::is_none")]
    pub companies: Option<Vec<crate::models::ApiV1UsersCompanySerializer>>,
}

impl ApiV1UsersMeSerializer {
    pub fn new() -> ApiV1UsersMeSerializer {
