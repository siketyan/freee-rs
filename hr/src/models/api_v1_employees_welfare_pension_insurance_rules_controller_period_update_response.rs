...
pub struct ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateResponse {
...
impl ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateResponse {
    pub fn new() -> ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateResponse {
        ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateResponse {
            employee_welfare_pension_insurance_rule: None,
        }
    }
}
