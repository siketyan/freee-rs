...
pub struct ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateDependentsBody {
    /// 更新対象事業所ID（必須）
    #[serde(rename = "company_id")]
    pub company_id: i32,
    /// 家族情報
    #[serde(rename = "dependents")]
    pub dependents: Vec<crate::models::ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializer>,
}

impl ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateDependentsBody {
    pub fn new(company_id: i32, dependents: Vec<crate::models::ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializer>) -> ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateDependentsBody {
        ApiV1EmployeeYearendAdjustmentControllerPeriodUpdateDependentsBody {
            company_id,
            dependents,
        }
    }
