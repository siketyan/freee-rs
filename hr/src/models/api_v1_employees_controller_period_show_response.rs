...
pub struct ApiV1EmployeesControllerPeriodShowResponse {
    #[serde(rename = "employee", skip_serializing_if = "Option::is_none")]
    pub employee: Option<Box<crate::models::ApiV1EmployeeSerializer>>,
}

impl ApiV1EmployeesControllerPeriodShowResponse {
    pub fn new() -> ApiV1EmployeesControllerPeriodShowResponse {
