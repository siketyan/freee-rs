...
pub struct ApiV1EmployeeYearendAdjustmentPreviousJobSerializer {
    /// 前職の支払金額
    ...
    /// 前職の源泉徴収額
    #[serde(rename = "withholding_tax_amount", skip_serializing_if = "Option::is_none")]
    pub withholding_tax_amount: Option<i32>,
    /// 前職の社名
...
impl ApiV1EmployeeYearendAdjustmentPreviousJobSerializer {
    pub fn new() -> ApiV1EmployeeYearendAdjustmentPreviousJobSerializer {
