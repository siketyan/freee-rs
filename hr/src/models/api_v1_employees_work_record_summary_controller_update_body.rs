...
pub struct ApiV1EmployeesWorkRecordSummaryControllerUpdateBody {
    /// 事業所ID（必須）
...
impl ApiV1EmployeesWorkRecordSummaryControllerUpdateBody {
    pub fn new(company_id: i32) -> ApiV1EmployeesWorkRecordSummaryControllerUpdateBody {
