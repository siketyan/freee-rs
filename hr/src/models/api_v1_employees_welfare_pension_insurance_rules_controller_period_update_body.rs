...
pub struct ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateBody {
    /// 更新対象事業所ID（必須）
    ...
    #[serde(rename = "year")]
    pub year: i32,
    /// 更新対象月（必須）<br> 締日支払日設定が翌月払いの従業員情報の場合は、 指定したmonth + 1の値が更新されます。<br> 翌月払いの従業員の2022/01の従業員情報を更新する場合は、year=2021,month=12を指定してください。<br>
    #[serde(rename = "month")]
    pub month: i32,
    #[serde(rename = "employee_welfare_pension_insurance_rule")]
    pub employee_welfare_pension_insurance_rule: Box<crate::models::ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializer>,
}

impl ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateBody {
    pub fn new(company_id: i32, year: i32, month: i32, employee_welfare_pension_insurance_rule: crate::models::ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializer) -> ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateBody {
        ApiV1EmployeesWelfarePensionInsuranceRulesControllerPeriodUpdateBody {
            company_id,
            year,
            month,
            employee_welfare_pension_insurance_rule: Box::new(employee_welfare_pension_insurance_rule),
        }
    }
}
