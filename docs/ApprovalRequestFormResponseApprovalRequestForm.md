...
**parts** | Option<[**Vec<crate::models::ApprovalRequestResponseApprovalRequestApprovalRequestFormParts>**](approvalRequestResponse_approval_request_approval_request_form_parts.md)> | 申請フォームの項目 | [optional]
