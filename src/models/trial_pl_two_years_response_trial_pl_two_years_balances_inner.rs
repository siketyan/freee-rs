...
pub struct TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub sections: Option<Vec<crate::models::TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInnerSectionsInner>>,
...
impl TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInner {
    pub fn new() -> TrialPlTwoYearsResponseTrialPlTwoYearsBalancesInner {
