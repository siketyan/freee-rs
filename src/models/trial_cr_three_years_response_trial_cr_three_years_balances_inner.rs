...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub items: Option<Vec<crate::models::TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerItemsInner>>,
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment1TagsInner>>,
    ...
    pub segment_2_tags: Option<Vec<crate::models::TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment2TagsInner>>,
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment3TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInner {
    pub fn new() -> TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInner {
