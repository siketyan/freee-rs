...
pub struct TrialCrResponseTrialCrBalancesInnerSegment3TagsInner {
    /// セグメント3タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント3タグ名
...
impl TrialCrResponseTrialCrBalancesInnerSegment3TagsInner {
    pub fn new(id: i32) -> TrialCrResponseTrialCrBalancesInnerSegment3TagsInner {
