...
pub struct TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub sections: Option<Vec<crate::models::TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInnerSectionsInner>>,
...
impl TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInner {
    pub fn new() -> TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInner {
