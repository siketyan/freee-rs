...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment2TagsInner {
    /// セグメント2タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント2タグ名
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment2TagsInner {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment2TagsInner {
