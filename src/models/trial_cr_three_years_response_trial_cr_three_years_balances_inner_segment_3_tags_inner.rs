...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment3TagsInner {
    /// セグメント3タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント3タグ名
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment3TagsInner {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerSegment3TagsInner {
