...
pub struct TrialCrSectionsResponseTrialCrSectionsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub sections: Option<Vec<crate::models::TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialCrSectionsResponseTrialCrSectionsBalancesInner {
    pub fn new() -> TrialCrSectionsResponseTrialCrSectionsBalancesInner {
