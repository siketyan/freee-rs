...
pub struct TrialCrResponseTrialCrBalancesInnerSegment1TagsInner {
    /// セグメント1タグID
    #[serde(rename = "id")]
    pub id: i32,
    /// セグメント1タグ名
...
impl TrialCrResponseTrialCrBalancesInnerSegment1TagsInner {
    pub fn new(id: i32) -> TrialCrResponseTrialCrBalancesInnerSegment1TagsInner {
