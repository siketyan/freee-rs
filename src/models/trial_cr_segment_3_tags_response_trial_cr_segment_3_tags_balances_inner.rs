...
pub struct TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub segment_3_tags: Option<Vec<crate::models::TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInnerSegment3TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
    pub fn new() -> TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
