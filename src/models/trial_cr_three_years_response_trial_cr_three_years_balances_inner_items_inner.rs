...
pub struct TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerItemsInner {
    /// 品目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 品目
...
impl TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerItemsInner {
    pub fn new(id: i32) -> TrialCrThreeYearsResponseTrialCrThreeYearsBalancesInnerItemsInner {
