...
pub struct TrialCrResponseTrialCrBalancesInnerItemsInner {
    /// 品目ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 品目
...
impl TrialCrResponseTrialCrBalancesInnerItemsInner {
    pub fn new(id: i32) -> TrialCrResponseTrialCrBalancesInnerItemsInner {
