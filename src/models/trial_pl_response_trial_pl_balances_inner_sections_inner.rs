...
pub struct TrialPlResponseTrialPlBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialPlResponseTrialPlBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialPlResponseTrialPlBalancesInnerSectionsInner {
