...
pub struct TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInner {
    /// 勘定科目ID(勘定科目の時のみ含まれる)
    ...
    pub segment_1_tags: Option<Vec<crate::models::TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner>>,
    /// 勘定科目カテゴリー名
...
impl TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInner {
    pub fn new() -> TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInner {
