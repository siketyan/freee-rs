...
pub struct TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInnerSectionsInner {
    /// 部門ID
    #[serde(rename = "id")]
    pub id: i32,
    /// 部門名
...
impl TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInnerSectionsInner {
    pub fn new(id: i32) -> TrialPlThreeYearsResponseTrialPlThreeYearsBalancesInnerSectionsInner {
